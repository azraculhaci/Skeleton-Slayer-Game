...
import com.azrac.parkourgamee.entities.Player;
import com.azrac.parkourgamee.entities.Weapons;
import com.azrac.parkourgamee.entities.enemies.Skeleton;
import com.azrac.parkourgamee.environments.Doorway;
import com.azrac.parkourgamee.environments.MapManager;
...
import com.azrac.parkourgamee.ui.PlayingUI;
...
//        canvas.drawRect(c.getHitbox().left + cameraX, c.getHitbox().top + cameraY, c.getHitbox().right + cameraX, c.getHitbox().bottom + cameraY, redPaint);
    ...
    private void updatePlayerMove(double delta) {
        ...
        float baseSpeed = (float) (delta * 500);
